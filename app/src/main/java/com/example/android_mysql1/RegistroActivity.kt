...
class RegistroActivity : AppCompatActivity() {
    ...
    fun cargarDatos(){
        ...
        val url = "http://192.168.1.3/android_mysql1/consulta.php?id=$id"
    ...
    fun eliminar(Vista: View){
        val url = "http://192.168.1.3/android_mysql1/borrar.php"
        procesoEnCola= Volley.newRequestQueue(this)
    ...
    fun editar(Vista: View){
        val url = "http://192.168.1.3/android_mysql1/editar.php"
        procesoEnCola = Volley.newRequestQueue(this)
